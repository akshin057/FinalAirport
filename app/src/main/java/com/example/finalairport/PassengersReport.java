...
public class PassengersReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        returnBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(PassengersReport.this, DirectorMain.class);
    ...
    public void init() {
        ...
        graphView.setTitle("График приема пассажиров по часам");
        ...
        myRef = FirebaseDatabase.getInstance().getReference()
                .child("Passengers").child(date);

        if (!(myRef != null)) {
            Toast.makeText(getApplicationContext(), "Нет отчета за данную дату", Toast.LENGTH_LONG).show();
        }

        PassengersInfo passengersInfo = new PassengersInfo(new HashMap<String, Integer>());
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        passengersInfo.addInfo(dataSnapshot.getKey(), dataSnapshot.getValue(Integer.class));
                    }

                    String[] strings = passengersInfo.getStringInfo();
